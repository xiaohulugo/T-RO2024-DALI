...
from train_utils.train_mine_utils import train_model_mine
...
def parse_config():
    ...
    #args.pretrained_model = '/home/lxh/Documents/Code/Detection3D/DALI_TRO/output/secondiou_nuscenes2kitti_iter2/default/ckpt/checkpoint_epoch_40.pth'
    args.batch_size = 4
    args.workers = 8
    args.epochs = 40
...
def main():
    ...
    #
    if True:
        if cfg.CAD3D_CONFIG.SOURCE == 'waymo':
    ...
    if True:
        target_set, target_loader, target_sampler = build_dataloader(
            dataset_cfg=cfg.DATA_CONFIG_CAD,
            class_names=cfg.DATA_CONFIG_CAD.CLASS_NAMES,
            batch_size=args.batch_size,
            dist=dist_train, workers=args.workers,
            logger=logger,
            training=True,
    ...
    # remember to change dataset here!
    ...
    train_func(
        ...
        logger=logger,
        ema_model=None,
        total_it_each_epoch = total_iters_each_epoch
    )
